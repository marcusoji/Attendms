...
app.post('/register/lecturer', asyncHandler(async (req, res) => {
...
// Create course route
app.post('/courses', verifyToken, asyncHandler(async (req, res) => {
...
app.get('/courses', verifyToken, asyncHandler(async (req, res) => {
    if (req.user.type !== 'lecturer') {
...
app.get('/attendance/:courseId', verifyToken, asyncHandler(async (req, res) => {
    if (req.user.type !== 'lecturer') {
...
app.get('/student/attendance', verifyToken, asyncHandler(async (req, res) => {
...
app.get('/debug/codes', verifyToken, asyncHandler(async (req, res) => {
...
app.post('/generate-code', verifyToken, asyncHandler(async (req, res) => {
    if (req.user.type !== 'lecturer') {
...
app.post('/mark-attendance', verifyToken, asyncHandler(async (req, res) => {
    if (req.user.type !== 'student') {
...
app.get('/attendance/:courseId/sessions', verifyToken, asyncHandler(async (req, res) => {
    if (req.user.type !== 'lecturer') {
...
app.get('/attendance/:courseId/date/:date', verifyToken, asyncHandler(async (req, res) => {
    if (req.user.type !== 'lecturer') {
...
app.get('/courses/:courseId/stats', verifyToken, asyncHandler(async (req, res) => {
    if (req.user.type !== 'lecturer') {
